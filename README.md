...
![DS-Exemple1.png](src/uml/DS-Exemple1.png)

### Diagrama de seqüència: exemple de bloc condicional alt
![alt](/src/uml/Exemple-Alt.png)

### Diagrama de seqüència: exemple de bloc iteratiu loop
![loop](/src/uml/Exemple-Loop.png)

### Diagrama de seqüència del CU: Prèstec de biblio
![DS-Biblioteca-CU-DemanarPréstec.png](src/uml/DS-Biblioteca-CU-DemanarPr%C3%A9stec.png)

### Diagrama de seqüència del CU: Cerca de llibre a biblio 
![DS-Biblioteca-CU-BuscarLlibre.png](src/uml/DS-Biblioteca-CU-BuscarLlibre.png)

### Diagrama de seqüència del CU: Contractació de servei
![DS](src/uml/DS-ContractacióServei.png)

### Diagrama de seqüència dels múltiples CU de Biblioteca
![Biblioteca](/src/uml/DS-Biblioteca-Complet.png)
